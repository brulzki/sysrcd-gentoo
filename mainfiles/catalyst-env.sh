export VIDEO_CARDS="vesa nv radeon dummy glint intel i128 i740 mach64 mga r128 rendition s3 s3virge siliconmotion trident sis savage cirrus voodoo sisusb ast tdfx via vmware apm"
