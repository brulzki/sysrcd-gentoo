...
LICENSE="GPL-2"
SLOT="0"
IUSE="+cramfs crypt ncurses nls old-linux perl selinux slang uclibc unicode loop-aes"
...
src_prepare() {
	...
	use loop-aes && epatch ${FILESDIR}/util-linux-2.19-loopaes-20110510.patch.bz2 || die 'util-linux patch failed'
	elibtoolize
}
