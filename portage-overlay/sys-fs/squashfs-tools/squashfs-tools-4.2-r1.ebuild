...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/squashfs-tools/squashfs-tools-4.2.ebuild,v 1.1 2011/03/15 20:47:11 jlec Exp $
...
src_configure() {
	...
	epatch "${FILESDIR}/squashfs-4.2-fix-gzip-null.patch" || die
