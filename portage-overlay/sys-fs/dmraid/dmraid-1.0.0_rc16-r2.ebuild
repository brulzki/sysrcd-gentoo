...
src_prepare() {
	...
	epatch "${FILESDIR}/dmraid-1.0.0.rc16-test_devices.patch"
	epatch "${FILESDIR}/ddf1_lsi_persistent_name.patch"
	epatch "${FILESDIR}/pdc_raid10_failure.patch"
	epatch "${FILESDIR}/return_error_wo_disks.patch"
	epatch "${FILESDIR}/fix_sil_jbod.patch"
	epatch "${FILESDIR}/avoid_register.patch"
	epatch "${FILESDIR}/move_pattern_file_to_var.patch"
	epatch "${FILESDIR}/libversion.patch"
	epatch "${FILESDIR}/libversion-display.patch"
	epatch "${FILESDIR}/bz567922_link_libpthread.patch"
	epatch "${FILESDIR}/dmraid-1.0.0_rc16-as-needed.patch"
}
