...
src_prepare() {
	...
	epatch ${FILESDIR}/parted-2.3-lpn.patch || die
	epatch ${FILESDIR}/parted-2.3-mac-logical-sector-size.patch
	epatch ${FILESDIR}/parted-2.3-Document-align-check-642476.patch
	epatch ${FILESDIR}/0001-Problem-with-Linux-3.0.patch
