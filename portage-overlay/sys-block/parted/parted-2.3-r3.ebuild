...
src_prepare() {
	...
	epatch "${FILESDIR}/fix-head-size-assertion.patch" || die 'patch'
	epatch "${FILESDIR}/dm_p_separator.patch" || die 'patch'
	...
	epatch "${FILESDIR}/dasd-sync.patch" || die 'patch'
	...
	epatch "${FILESDIR}/update-abi-symbols.patch" || die 'patch'
