...
SRC_URI="http://www.kernel.org/pub/linux/kernel/v3.x/linux-3.3.tar.bz2"
...
src_unpack()
{
	...
	ln -s linux-${KV} linux
	cd linux-${KV}
	epatch ${FILESDIR}/alt-sources-3.3-01-stable-3.3.7.patch.bz2 || die "alt-sources stable patch failed."
	...
	sed -i -e "s/${oldextra}/EXTRAVERSION = -alt271/" Makefile
