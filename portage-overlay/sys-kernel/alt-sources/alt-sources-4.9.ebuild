...
src_unpack()
{
	...
	epatch ${FILESDIR}/alt-sources-4.9-01-stable-4.9.18.patch.xz || die "alt-sources stable patch failed."
	epatch ${FILESDIR}/alt-sources-4.9-02-fc24.patch.xz || die "alt-sources fedora patch failed."
	...
	sed -i -e "s/${oldextra}/EXTRAVERSION = -alt495/" Makefile
}
