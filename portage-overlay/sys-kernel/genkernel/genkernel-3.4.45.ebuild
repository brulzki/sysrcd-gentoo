...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/genkernel/genkernel-3.4.45.ebuild,v 1.6 2013/01/22 00:51:58 ikelos Exp $
...
src_unpack() {
    ...
    # sysresccd customization for initramfs
    ( cd "${S}" ; epatch ${FILESDIR}/genkernel-3.4.45-sysrcd.patch )

	# sysresccd needs more modules in defaults/modules_load (eg: network drivers)
    for arch in x86 x86_64
    do
        cp "${FILESDIR}/modules_load" "${S}/arch/$arch/modules_load"
    done
}
